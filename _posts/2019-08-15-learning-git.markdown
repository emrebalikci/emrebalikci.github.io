...
style: fill
color: dark
description: Git is a Distributed Version Controlling System (DVCS). it believes work-local, commit-often, publish-when-you-can methodology. It is primarily written in C.
---
...
**Gitlab** - [gitlab.com](gitlab.com) is a web-based DevOps lifecycle tool that provides a Git-repository manager providing wiki, issue-tracking and CI/CD pipeline features, using an open-source license, developed by GitLab Inc
...
3. https://www.gitkraken.com/learn-git
4. https://devdocs.io/git/
